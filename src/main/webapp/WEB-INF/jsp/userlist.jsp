...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
        <div class="right">
			...
			<div class="providerView" style="display: none">
				<p><strong>用户编号：</strong><span id="userCode1"></span></p>
				<p><strong>用户名称：</strong><span id="userName1"></span></p>
				<p><strong>用户性别：</strong><span id="gender1"></span></p>
				<p><strong>出生日期：</strong><span id="birthday1"></span></p>
				<p><strong>用户电话：</strong><span id="phone1"></span></p>
				<p><strong>用户地址：</strong><span id="address1"></span></p>
				<p><strong>用户角色：</strong><span id="userRole1"></span></p>
			</div>
